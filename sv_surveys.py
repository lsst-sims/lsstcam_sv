...
# For all surveys, we want a standard exposure time and visit
NEXP = 1
U_NEXP = 1
EXPTIME = 30.0
U_EXPTIME = 38.0
...
def gen_lvk_templates(
    ...
    footprints_hp: npt.NDArray | None = None,
    camera_rot_limits: tuple[float, float] = (-80.0, 80.0),
...
def gen_ddf_surveys(
    ...
    nsnaps: dict = {"u": U_NEXP, "g": NEXP, "r": NEXP, "i": NEXP, "z": NEXP, "y": NEXP},
    survey_start: float = SURVEY_START_MJD,
